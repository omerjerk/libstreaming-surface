...
public abstract class VideoStream extends MediaStream {
    ...
    private Surface mCInputSurface;
...
//		unlockCamera();
		...
		try {
			...
			if (mMode == MODE_MEDIACODEC_API_3) {
	...
	protected void configureEncoder() throws IOException {
...
//		mMediaCodec = MediaCodec.createEncoderByType("video/avc");
    ...
    public synchronized Surface getSurface() {
		if (mCInputSurface == null) {
			throw new IllegalStateException("Surface is null. Did you not configure the encoder yet?");
		} else {
			Log.d(TAG, "Forwarding the surface to main app");
		}
        return mCInputSurface;
    }
